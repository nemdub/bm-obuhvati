...
function labelBundle(script: Script) {
  ...
  return {
    ...
    doesNotExist: t("doesNotExist"), discardMatch: t("discardMatch"), streetMissing: t("streetMissing"),
    ...
    parityAll: t("parityAll"), parityOdd: t("parityOdd"), parityEven: t("parityEven"), toEnd: t("toEnd"),
