...
export const REVIEW_REASONS: Record<string, string> = {
  ...
  abbrev: "Име скраћено на иницијал — повезано са улицом из регистра (проверити)",
  ...
  osm_fallback: "Улица/насеље није у регистру — обухват је процењен преко OpenStreetMap (проверити). Да га уклоните: обришите покривање или притисните „Улица не постоји“. Полигон се освежава при следећем прорачуну.",
